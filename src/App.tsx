...
import {FormStyleProvider, FormStyleToggle, useFormStyle} from "@/components/providers/form-style"
import {ViewModeProvider, ViewModeToggle, useViewMode} from "@/components/providers/view-mode"
...
const ResponsiveContainer = ({heading, actions, children}: ResponsiveContainerProps) => {
    return (
        <div className="flex items-center justify-center [&>div]:w-full">
            <div className="overflow-hidden bg-background sm:rounded-t-lg">
                <div
                    className="flex items-center justify-between border bg-background px-4 py-5 sm:rounded-t-lg sm:px-6">
                ...
                <div className="overflow-hidden  border bg-background shadow">
                    <div className="items-start justify-center gap-6 p-8 md:grid md:grid-cols-2">
                        <div className="col-span-2 grid items-start gap-6 lg:col-span-1">
                            ...
                            <div>
                                <div
                                    className="grid grid-cols-1 items-start justify-center gap-6 md:grid md:grid-cols-2">
